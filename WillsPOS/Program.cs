...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Auth Demo API", Version = "v1" });
...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        var adminEmail = "junanthony.business@gmail.com";
        ...
        await userManager.CreateAsync(admin, "J@nth0ny25");
